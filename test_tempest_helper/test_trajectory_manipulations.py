...
class TestFillTrajectoryGaps(TempestHelperTestCase):
    ...
    def test_fill_traj_gap_increasing(self):
        ...
        expected = {
            ...
            "day": [1, 1, 1, 1, 2],
            "hour": [0, 6, 12, 18, 0],
            "psl_min": [100000.0, 99999.0, 99998.0, 99997.0, 99996.0],
...
class TestStormsOverlapInTime(TempestHelperTestCase):
    ...
    def test_simple(self):
        ...
        storm = {
            ...
            "day": [1, 1, 1],
            "hour": [0, 6, 12],
            "psl_min": [100000.0, 99999.0, 99998.0],
...
class TestStormOverlapInSpace(TempestHelperTestCase):
    ...
    def setUp(self):
        ...
        self.storm4 = {
            ...
            "day": [1, 1, 1, 2],
            "hour": [6, 12, 18, 0],
            "psl_min": [100000.0, 99999.0, 99998.0, 99997.0],
...
class TestRemoveDuplicatesFromTrackFiles(TempestHelperTestCase):
    ...
    def test_simple(self):
        ...
        storm_current = {
            ...
            "day": [1, 1, 2],
            "hour": [12, 18, 0],
            "psl_min": [99999.0, 99998.0, 99997.0],
